...
class MockLLMProvider(LLMProvider):
    ...
    async def complete(self, prompt: str) -> LLMResponse:
        ...
        payload = {
            ...
            "root_cause": (
                "MOCK_örnek kök neden: bu sahte bir teşhistir, gerçek LLM bağlanınca değişecek."
            ),
            "error_type": "MOCK_ExampleError",
            "verdict": "test_maintenance",
            "explanation": (
                "MOCK_ bu sahte bir açıklamadır; kanıta dayalı gerçek yorum yerine sabit örnek."
            ),
            "suggestion": (
                "MOCK_ örnek öneri: gerçek LLM sağlayıcısını .env üzerinden etkinleştirin."
            ),
